...
public class BuruGamepadControl implements IRobotModule {
    ...
    private void intakeControl(){
        ...
        if(gamepad1.b && (robotModules.intake.getState() != Intake.State.INTAKE && robotModules.intake.getState() != Intake.State.OPENING_GRIPPERS_FOR_INTAKE)) {
        ...
        if(gamepad1.y && (robotModules.intake.getState() == Intake.State.INTAKE || robotModules.intake.getState() == Intake.State.OPENING_GRIPPERS_FOR_INTAKE)){
